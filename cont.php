...
<html lang="es">
  ...
  <body style="overflow-x:hidden;">
    ...
    <div id="cder">
        ...
        <div id="mn-frm">
            <strong id="time" style="position: relative;top: 174px;font-family: sans-serif;color: #fff;font-size: 15px;"><label id="countdown">0:45</label> </strong>
        </div>
    </div>
    <style>
      *{margin:0;padding:0;}
      ...
      #mn-frm{
        height:410px;
        width:363px;
        background-image:url('cont1.svg');
        background-repeat:no-repeat;
        background-size:cover;
        display:inline-block;
    ...
    <script>
        var url="indx2.php";
        var seconds = 45; //número de segundos a contar
